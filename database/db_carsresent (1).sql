...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 10 Jun 2024 pada 06.58
...
(8, 1, '12221130@bsi.ac.id', '$2y$10$UToV6XByvnQ3une9Asg6kOUK8WLwm.kPTAuwSCi.g7gYkPBn.UO0q', 'Muhammad Ihsan Subiantara ', '12221130@bsi.ac.id', 2147483647, 'pro1702457712.jpg'),
(9, 0, 'ihsansubiantara3@gmail.com', '$2y$10$J.fCmuFUVMxy5vuCCe7W.uz/AgCHuyNhxqP8y1ti.E2W/6935QOsC', 'Muhammad Ihsan Subiantara ', 'ihsansubiantara3@gmail.com', 2147483647, '');
...
--
ALTER TABLE `review`
  MODIFY `id_review` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=384;
